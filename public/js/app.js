  ...
  if (post !== undefined) {
    ...
    $(document).on('click', '.like-post', function () {
      ...
      if (liked_posts && liked_posts.hasOwnProperty(post.slug) && liked_posts[post.slug].liked) {
        var options = {
          type: 'warning',
          icon: 'fa fa-fw fa-circle-exclamation me-1',
          from: 'bottom',
  ...
  if ($('#posts').length) {
    var params = {
      ...
      columns: [{
        ...
        render: function render(data, type, row, params) {
          return "<span title=\"".concat(row.published_at, "\">").concat(row.published_at_for_humans, "</span>");
        }
      }, {
        data: 'created_at',
        name: 'created_at',
        ...
        className: 'text-center fs-sm',
        render: function render(data, type, row, params) {
          return "<span title=\"".concat(row.created_at, "\">").concat(row.created_at_for_humans, "</span>");
        }
      }, {
        data: 'active',
        name: 'active',
