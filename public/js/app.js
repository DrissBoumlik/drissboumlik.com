...
// import 'bootstrap';
__webpack_require__(/*! particles.js */ "./node_modules/particles.js/particles.js"); // var slugify = require('slugify')
...
function initEvents() {
  $(document).on('focusout', '#post-title', function () {
    ...
    var postSlug = string_to_slug(postTitle); // slugify(postTitle, {
...
$(function () {
  try {
    ...
    (0,_functions__WEBPACK_IMPORTED_MODULE_0__.initDarkMode)(); // initEvents();
  } catch (error) {
    console.log(error);
  }
});
