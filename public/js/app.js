...
/* harmony import */ var _plugins_use__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins-use */ "./resources/js/plugins-use.js");
...
function init() {
  try {
    ...
    (0,_plugins_use__WEBPACK_IMPORTED_MODULE_1__.initPostPageEvent)();
    setTimeout(function () {
...
function toggleDarkMode(_body, isActive) {
  var highlightjs_href = 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.8.0/styles/';
  if (isActive) {
...
function initDarkMode() {
  ...
  $(document).on('click', '.toggle-dark-mode', function () {
    var _this = $(this);
    var _isActive = !_body.hasClass('dark-mode');
...
function initEvents() {
  ...
  $(document).on('submit', '.form-subscribe', function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        var subscribe_response = $('#form-subscribe-response');
        // let options = {
        ...
        subscribe_response.html(response.message).removeClass(subscribe_response.attr('data-class')).addClass(response["class"]).attr('data-class', response["class"]).removeAttr('hidden');
      },
  ...
  if (post !== undefined) {
    ...
    $(document).on('click', '.like-post', function () {
      ...
      var liked_posts = JSON.parse(localStorage.getItem('liked-posts'));
      var url = "/blog/like/".concat(post.slug);
      var unlike = 0;
  ...
  var show_password_btn = $('.show-password');
  if (show_password_btn.length) {
    show_password_btn.on('click', function () {
      var input_password = $(this).siblings('input');
      var type = input_password.attr('type') === 'text' ? 'password' : 'text';
...
/* harmony export */   initPostPageEvent: () => (/* binding */ initPostPageEvent),
  ...
  if ($('#posts').length) {
    var params = {
      ...
      columns: [{
        ...
        name: 'title',
        title: 'Title',
        className: 'fw-semibold fs-sm',
        render: function render(data, type, row, params) {
          return "<span data-bs-toggle=\"tooltip\" title=\"".concat(row.title, "\">").concat(row.short_title, "</span>");
        }
      }, {
        data: 'status',
        name: 'status',
        title: 'Status',
        render: function render(data, type, row, params) {
          return "<span class=\"fs-xs fw-semibold d-inline-block py-1 px-3 rounded-pill ".concat(row.status["class"], "\">").concat(row.status.text, "</span");
        }
      }, {
        data: 'featured',
        name: 'featured',
        ...
        data: 'tags_count',
        name: 'tags_count',
        title: '<i class="fa-solid fa-tags"></i>',
        className: 'text-center'
      }, {
        data: 'published_at',
        name: 'published_at',
        title: '<i class="fa-solid fa-upload"></i>',
        className: 'text-center fs-sm',
        render: function render(data, type, row, params) {
          return "<span title=\"".concat(row.published_at_formatted, "\">").concat(row.published_at_for_humans, "</span>");
        }
      }, {
        data: 'created_at',
        name: 'created_at',
        title: '<i class="fa-solid fa-pen"></i>',
        className: 'text-center fs-sm',
        render: function render(data, type, row, params) {
          return "<span title=\"".concat(row.created_at_formatted, "\">").concat(row.created_at_for_humans, "</span>");
        }
      }, {
        data: 'active',
        name: 'active',
        ...
        className: 'fs-sm',
        render: function render(data, type, row, params) {
          return "<div class=\"item item-tiny item-circle mx-auto mb-3 ".concat(row.active ? 'bg-success' : 'bg-danger', "\"></div>");
        }
      }
  ...
  if ($('#tags').length) {
    var _params = {
      ...
      columns: [{
        ...
        className: 'text-center',
        render: function render(data, type, row, params) {
          return "\n                        <div class=\"btn-group\">\n                            <button type=\"button\" class=\"btn btn-sm btn-outline-secondary js-bs-tooltip-enabled\" data-bs-toggle=\"tooltip\" aria-label=\"Edit Client\" data-bs-original-title=\"Edit Client\">\n                                <a href=\"/tags/".concat(row.slug, "\" target=\"_blank\" class=\"link-dark\">\n                                    <i class=\"fa fa-fw fa-eye\"></i>\n                                </a>\n                            </button>\n                            <button type=\"button\" class=\"btn btn-sm btn-outline-secondary js-bs-tooltip-enabled\" data-bs-toggle=\"tooltip\" aria-label=\"Edit Client\" data-bs-original-title=\"Edit Client\">\n                                <a href=\"/admin/tags/edit/").concat(row.slug, "\" target=\"_blank\" class=\"link-dark\">\n                                    <i class=\"fa fa-fw fa-pencil-alt\"></i>\n                                </a>\n                            </button>\n                        </div>\n                    ");
        }
      }, {
        data: 'id',
        name: 'id',
        ...
        className: 'fw-semibold fs-sm',
        render: function render(data, type, row, params) {
          return "<div class=\"item item-tiny item-circle mx-auto mb-3\"\n                             style=\"background-color: ".concat(row.color, "\"></div>");
        }
      }, {
        data: 'posts_count',
        name: 'posts_count',
  ...
  if ($('#visitors').length) {
    var _params2 = {
      ...
      columns: [{
        ...
        data: 'visits_count',
        name: 'visits_count',
        title: '<i class="fa fa-fw fa-eye"></i>',
        className: 'fw-semibold fs-sm'
      }, {
        data: 'updated_at',
        name: 'updated_at',
        ...
        className: 'text-center fs-sm',
        render: function render(data, type, row, params) {
          return "<span title=\"".concat(row.updated_at_formatted, "\">").concat(row.updated_at_formatted, "</span>");
        }
      }, {
        data: 'countryCode',
        name: 'countryCode',
...
function configDT(params) {
  var table = new DataTable(params.id, {
    language: {
      // select: {
      //     style: 'single',
      //     info: false
      ...
      fnInfoCallback: function fnInfoCallback(settings, start, end, max, total, pre) {
        return "".concat(start, " <i class=\"fa-solid fa-arrow-right-long\"></i> ").concat(end, " | ").concat(total, " (Total : ").concat(max, ")");
      },
      paginate: {
...
/******/ 	__webpack_require__.O(undefined, ["css/externals","css/app","template/css/main"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/externals","css/app","template/css/main"], () => (__webpack_require__("./resources/template/sass/main.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/externals","css/app","template/css/main"], () => (__webpack_require__("./resources/sass/externals.sass")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/externals","css/app","template/css/main"], () => (__webpack_require__("./resources/sass/app.sass")))
