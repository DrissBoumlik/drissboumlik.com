...
<div class="main-error-page">
    ...
    >
        ...
        <g fill="none" fill-rule="evenodd">
            <path fill="#09182f" d="M0 0H1366V800H0z" transform="translate(-448 -158)"/>
            <g>
    ...
    <h1 class="error-title">
        Woops! <br>Still working on something :(
    </h1>
    <h1 class="error-subtitle">
        Checkout my <a href="/resume" style="color: #fff;">resume</a>
    </h1>
</div>
</body>
</html>
