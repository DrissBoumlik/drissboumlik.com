                                ...
                                <div class="col-12 col-lg-6 offset-lg-3">
                                    <form id="contact-form">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="form-subject" placeholder="" name="subject" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="form-body" class="form-label">Message</label>
                                            <textarea class="form-control" id="form-body" rows="3" name="body" maxlength="1000"></textarea>
                                        </div>
