                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                                ...
                                <p class="block-content">Thank you for visiting <a href="{{ \URL::to('/') }}">drissboumlik.com</a> (the "Website").
                                    Your privacy is important to us,
                                    and we are committed to protecting your personal information. This Privacy Policy explains how we collect,
                                    use, and disclose personal information when you use our Website.</p>

                                <h4 class="block-title">Information Collection and Use</h4>
                                <p class="block-content">While using our Site, we may ask you to provide us with certain personally identifiable
                                ...
                                <p class="block-content">Cookies are files with small amounts of data, which may include an anonymous unique identifier.
                                    Cookies are sent to your browser from a website and stored on your computer's hard drive.</p>
                                <p class="block-content">Like many sites, we use "cookies" to collect information. You can instruct your browser to refuse
                                ...
                                <p class="block-content">The security of your Personal Information is important to us, but remember that no method of transmission
                                ...
                                <p class="block-content">This Privacy Policy is effective as of 11/20/2023 and will remain in effect except with respect to any
                                    changes in its provisions in the future, which will be in effect immediately after being posted on this page.</p>
                                <p class="block-content">We reserve the right to update or change our Privacy Policy at any time, and you should check this
                                ...
                                <p class="block-content">If we make any material changes to this Privacy Policy, we will notify you either through the email
                                    address you have provided us or by placing a prominent notice on our website.</p>

                                <h4 class="block-title">Contact Us</h4>
                                <p class="block-content">If you have any questions about this Privacy Policy, please contact through:</p>
                                <ul class="ms-3">
