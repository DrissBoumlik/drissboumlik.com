<div class="py-5">
    <div class="section competences pt-5" id="competences">
        <div class="container">
    ...
    <div class="section languages mt-5 pt-5" id="languages">
        <div class="container">
    ...
    <div class="section add-skills mt-5 pt-5" id="add-skills">
        <div class="container">
