                                ...
                                <form id="contact-form" class="contact-form mb-3 mb-md-0">
                                    ...
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" id="form-body" rows="3" name="body"
                                                  placeholder="" required maxlength="1000"></textarea>
                                    ...
                                    <div class="btns d-flex gap-2">
                                        <button type="submit"
                                                class="btn tc-blue-dark-2-bg tc-blue-bg-hover w-100 br-50px">Send</button>
                                        <a href="https://calendly.com/drissboumlik/30min" target="_blank"
                                           class="btn tc-blue-dark-1-outline tc-blue-dark-1-bg-hover w-100 br-50px">
