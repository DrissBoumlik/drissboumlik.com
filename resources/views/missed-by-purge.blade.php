...
pl-kolp
pl-kos
pl-eoai pl-eoac pl-pde
copyable-terminal pl-c pl-c1 pl-cce pl-cn pl-coc pl-cos pl-e pl-ef
api CodeMirror blob-code blob-num blob-code blob-code-inner
pl-kou
pl-mai pl-sf
pl-mb
pl-mc
...
body dark-mode
    ...
    //
     ...
     hljs-emphasis
/* PrismJS 1  29  0
https://prismjs  com/download  html#themes=prism-tomorrow&languages=markup+css+clike+javascript+apacheconf+arduino+aspnet+bash+basic+c+csharp+cpp+css-extras+dart+docker+graphql+http+java+javadoc+javadoclike+javastacktrace+less+lua+makefile+markdown+markup-templating+mongodb+nginx+php+phpdoc+php-extras+plsql+powershell+pug+python+cshtml+jsx+tsx+ruby+sass+scss+sql+twig+typescript+typoscript+vbnet+vim+xml-doc+yaml&plugins=line-highlight+line-numbers+custom-class+file-highlight+jsonp-highlight+highlight-keywords+treeview */
...
>
    ...
    <select class="js-select2 tc-red-light tc-alert-ok tc-orange-red form-select js-select2-enabled select2-hidden-accessible" id="tags-list" name="tags[]" style="width: 100%;" data-placeholder="Choose many.." multiple="" data-select2-id="tags-list" tabindex="-1" aria-hidden="true">
        ...
        <option value="4" selected="" data-select2-id="3">C#</option>
        <option value="5">debug</option>
        <option value="6">editors</option>
        <option value="7">ide</option>
        <option value="8">issues</option>
        <option value="9" selected="" data-select2-id="4">oop</option>
        <option value="10">programming</option>
        <option value="11">tricks</option>
        <option value="12">sdsd</option>
        <div class="pagination-wrapper justify-content-center">
            <nav>
                <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="http://localhost:8000/blog?page=2">2</a></li>


                    <li class="page-item">
                        <a class="page-link" href="http://localhost:8000/blog?page=2" rel="next" aria-label="Next »">›</a>
                    </li>
                </ul>
            </nav>
