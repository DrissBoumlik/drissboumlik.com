    ...
    plugins: [
        ...
        laravel({
            input: [
                ...
                // LOCAL/PAGE JS
                'resources/js/admin/pages/blog/blog.js',
                'resources/js/admin/pages/blog/post.js',
                'resources/js/admin/pages/file-manager.js',
                'resources/js/admin/pages/user-interaction/chart.js',
                'resources/js/admin/pages/user-interaction/user-interaction.js',
